...
ALL ITEM DATA LOOKS GREAT! I STILL NEED TO GO BACK TO THE TWO FILES IN THE FS_P006_Non_Produce_Information AND UPDATE THEM TO USE THE NEW DATA SET FROM GOOGLE SHEETS SO I CAN REMOVE THAT CODE AND HAVE ALL OF THIS DATA PERMANENTLY GOING TO THIS GIT REPO (AT THAT TIME I CAN ALSO MOVE ALL SUBSCRIPTION DATA IN AS WELL). THE AGGREGATED DELIVERY DATA MIGHT COME LATER, IF EVER??
