...
```{r}
# sheet_id = "194KKu7z0YYAiBHWh4R0D57GGumSyY9Stc_ssCry2uDA" #original source
sheet_id = "1BgaYDJZndIycyol3B9EXJ1Gxt2dyLZ7_ar2jB5VUKvM" #personal
...
member_page_init = member_page_home_del |> 
  ...
  mutate(last_modified_date = ymd_hms(last_modified_date)
          , sign_up = ymd(sign_up)
          , first_delivery_date = ymd(first_delivery_date)
          , last_delivery_date = ymd(last_delivery_date)
           )
...
## repo_location = 'C:/Users/Fair Shares/Documents/_ds_fairshares/Farmigo_Database/step_1_anonymization/Raw/'
 repo_location = 'C:/Users/rmarg/OneDrive/Documents/R/_ds_fairshares/Data/Farmigo_Database/step_1_anonymization/Raw/'
